...
public class ConfigurationSerialization
{
	...
	// public static void registerClass(Class<? extends
	// ConfigurationSerializable> clazz) {
	// DelegateDeserialization delegate =
	// clazz.getAnnotation(DelegateDeserialization.class);
	//
	// if (delegate == null) {
